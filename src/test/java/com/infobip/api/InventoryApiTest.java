...
public class InventoryApiTest extends ApiTest{
    ...
    void shouldOrderNumber() throws ApiException, JsonProcessingException {
        String givenRequest = "{\"state\":\"CA\",\"npa\":\"123\",\"nxx\":\"456\",\"type\":\"local\",\"applicationId\":\"app-1\",\"entityId\":\"entity-1\",\"quantity\":10}";
        String givenResponse = "{\"orderId\":\"12345\"}";

        setUpSuccessPostRequest(
                "/numbers/2/purchase-order", givenRequest, givenResponse);
    ...
    void shouldGetNumberOrderStatus() throws ApiException, JsonProcessingException {
        ...
        String givenResponse = "[{\"basicDetails\":{\"orderId\":\"123\",\"type\":\"234\"},\"billingDetails\":{\"setupFee\":\100.0,\"monthlyFee\":\"200.0\"},\"additionalData\":{\"state\":\"test\"}}]";
        setUpSuccessGetRequest(
                "/numbers/2/purchase-order/[" + orderId + "]/status",Map.of(),  givenResponse);
